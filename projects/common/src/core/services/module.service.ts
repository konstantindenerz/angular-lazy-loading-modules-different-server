...
export class ModuleService {
  ...
  static activate(components: { [selector: string]: Type<any> }, parentInjector: Injector, contextType: Type<any>) {
  ...
  public load({ files, url, selector }: Module, element: HTMLElement) {
